...
void MainWindow::setupConnections()
{
	...
	// 将视频转存为图片
	connect(extractvideroButton, SIGNAL(clicked()), this, SLOT(video2image()));
    // Importing
...
void MainWindow::video2image() {
	QFileDialog* fd = new QFileDialog(this);//创建对话框
	fd->resize(240, 320);    //设置显示的大小
	fd->setNameFilter(tr("mp4file(*.mp4);;All file(*.*)")); //设置文件过滤器
...
void MainWindow::launchImageImport()
{
	...
	//QString directory = "C:\\Users\\Alexia\\Desktop\\image";
